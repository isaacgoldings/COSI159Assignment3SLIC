...
def lab2rgb(path, lab_arr):
    rgb_arr = color.lab2rgb(lab_arr) #error : https://stackoverflow.com/questions/55319949/pil-typeerror-cannot-handle-this-data-type
    print(rgb_arr)
    rgb_arr = (rgb_arr*255).astype(np.uint8) #fix : https://blog.csdn.net/nsjdjdn/article/details/132105847
...
rgb = io.imread("campus-spring.jpg",plugin='matplotlib')
print(rgb.shape)
